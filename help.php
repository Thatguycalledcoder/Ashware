...
<div class="row">
    <div class="nav flex-column flex-shrink-0 p-3 text-black mx-3"
         style="width: 185px; background-color: #F8F8F8; border-right: 1px solid #D7D7D7;">
          <span class="fs-4 mb-2">
            ...
            <ul class="nav nav-pills flex-column mb-auto mt-5">
                ...
                <li class="">
                    <a href="help.php" class="nav-link active text-danger mb-2" style="background-color: #FFEBEB;">
                ...
                <li>
                    <a href="help.php?logout='1'" class="nav-link text-danger mb-2">
        ...
        <div id="mainpage" class="col mt-2">
            <h1 class="ms-5 mt-5">How may we help you</h1>
            <form class="ms-5 mt-5">
                <textarea rows="10" cols="90" placeholder="Enter issue here"></textarea><br>
                <input type="submit" class="login-btn" name="submit" value="Submit">
            </form>
        </div>
    </div>
</body>
